...
<<<<<<< HEAD
    def refresh(self) -> None:
        ...
        self._update_metrics(self._corrections)
...
<<<<<<< HEAD
        ...
        if self._path_loss_path and Path(path).resolve() == Path(self._path_loss_path).resolve():
            return

        # ── Pre-flight validation ────────────────────────────────────────────
        try:
            warnings = PathLossValidator.validate_file(path)
